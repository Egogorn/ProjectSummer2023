...
static void cls_OnKey( HWND hWnd, UINT vk, BOOL down, int repeat, UINT flags )
{
    ...
    switch ( vk )
    {
    case VK_CLEAR: push_key(pWndData,KEY_CENTER);
        break;
    case VK_PRIOR: push_key(pWndData,KEY_PGUP);
        break;
    case VK_NEXT: push_key(pWndData,KEY_PGDN);
        break;
    case VK_END: push_key(pWndData,KEY_END);
        break;
    case VK_HOME: push_key(pWndData,KEY_HOME);
        break;
    case VK_LEFT: push_key(pWndData,KEY_LEFT);
        break;
    case VK_UP: push_key(pWndData,KEY_UP);
        break;
    case VK_RIGHT: push_key(pWndData,KEY_RIGHT);
        break;
    case VK_DOWN: push_key(pWndData,KEY_DOWN);
        break;
    case VK_INSERT: push_key(pWndData,KEY_INSERT);
        break;
    case VK_DELETE: push_key(pWndData,KEY_DELETE);
        break;
    case VK_F1: push_key(pWndData,KEY_F1);
        break;
    case VK_F2: push_key(pWndData,KEY_F2);
        break;
    case VK_F3: push_key(pWndData,KEY_F3);
        break;
    case VK_F4: push_key(pWndData,KEY_F4);
        break;
    case VK_F5: push_key(pWndData,KEY_F5);
        break;
    case VK_F6: push_key(pWndData,KEY_F6);
        break;
    case VK_F7: push_key(pWndData,KEY_F7);
        break;
    case VK_F8: push_key(pWndData,KEY_F8);
        break;
    case VK_F9: push_key(pWndData,KEY_F9);
        break;
    case VK_F10: push_key(pWndData,KEY_F10);
        break;
    case VK_F11: push_key(pWndData,KEY_F11);
        break;
    case VK_F12: push_key(pWndData,KEY_F12);
        break;
    case VK_NUMLOCK: push_key(pWndData,KEY_NUM_LOCK);
        break;
    case VK_SCROLL: push_key(pWndData,KEY_SCROLL_LOCK);
        break;
    case VK_SHIFT: 
